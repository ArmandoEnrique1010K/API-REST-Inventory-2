...
public class ResponseServiceImpl implements ResponseService {
  ...
  @Transactional(readOnly = true)
  @Override
  public CommonResponseWithSecretField generateSucessfullResponseWithSecretField(ResponseStatus code, String message, String secretField) {

    return new CommonResponseWithSecretField(
        "success",
        // Tipo - Codigo HTTP - Tipo de respuesta - Mensaje
        code.getStatus().value(),
        // Aqui debe mostrar la respuesta por defecto o el que se le pase
