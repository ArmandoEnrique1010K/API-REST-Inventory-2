...
public class Model_DeliveryOrderController {
  ...
  public Model_DeliveryOrderController ( Model_DeliveryOrderService model_DeliveryOrderService, ResponseService responseService ){
    this.model_DeliveryOrderService = model_DeliveryOrderService;
    this.responseService = responseService;
  }

  @PostMapping("/model/{modelId}/deliveryOrder/{deliveryOrderId}")
  public ResponseEntity<CommonResponse> registerRelationModelToDeliveryOrder(@PathVariable Long modelId, @PathVariable Long deliveryOrderId) {
  ...
  public ResponseEntity<?> listAllModelsByDeliveryOrder(@PathVariable Long deliveryOrderId) {
    List<Model_DeliveryOrderResponse> model_DeliveryOrderListResponses = model_DeliveryOrderService.findAllByDeliveryOrderId(
        deliveryOrderId);

    DataResponse<List<Model_DeliveryOrderResponse>> dataResponse = responseService.generateDataResponse(ResponseStatus.SUCCESS, 
