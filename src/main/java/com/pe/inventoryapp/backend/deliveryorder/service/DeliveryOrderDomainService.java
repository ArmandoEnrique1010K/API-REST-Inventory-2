...
public class DeliveryOrderDomainService {
  ...
  // TODO: TRASLADAR ESTE MÉTODO EN MovementDomainService, ESTE MÉTODO ES REUTILIZABLE PARA CUALQUIER TIPO DE MOVIMIENTO, NO SOLO PARA LAS ORDENES DE ENTREGA
  // Genera un comentario para la cancelacion de una orden de entrega, si el comentario es nulo o vacio, se asigna un comentario por defecto
