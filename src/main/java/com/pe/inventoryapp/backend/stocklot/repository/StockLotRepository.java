...
public interface StockLotRepository extends JpaRepository<StockLot, Long> {
        ...
        // TODO: PODRIA SER NECESARIO ELIMINAR UNOS PARAMETROS DE LAS CONSULTAS DE
        // BUSQUEDA
        ...
        // AL MISMO PRODUCTO, PERO CON LA CONDICION DE QUE PIDA COMO REQUISITO UN ID DE
        // LOTE DE STOCK Y TOME EL ID DEL PRODUCTO DE ESE LOTE DE STOCK PARA QUE LISTE
        // TODOS LOS LOTES DE STOCK QUE CORRESPONDEN A ESE PRODUCTO, PERO QUE NO TOME EL
        // MISMO LOTE DE STOCK QUE CORRESPONDA A ESE ID Y QUE TENGA EL VALOR false EN EL
        // CAMPO ZEROSTOCK
        @Query("""
                        SELECT sl
                        FROM StockLot sl
